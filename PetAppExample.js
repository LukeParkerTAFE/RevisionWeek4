...
// Q4
// Write a function that returns the number of pets for each owner
// the return array should be an array of objects with ownerId and numberOfPets

function getPetCountByOwner() {
    const getPetsForOwner = (owner) => ({
        ownerId: owner.id,
        numberOfPets: getPetsByOwner(owner.id).length
    });
